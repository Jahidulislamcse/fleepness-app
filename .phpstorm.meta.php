    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Illuminate\Contracts\Broadcasting\Broadcaster' => \App\Support\Broadcaster\FcmBroadcaster::class,
            ...
            'Illuminate\Http\Client\Factory' => \App\Support\HttpClientFactory::class,
    ...
    override(\config(), map([
            ...
            'broadcasting.connections.fcm.driver' => 'string',
            ...
            'filesystems.links./Users/mdmohiuddinmostafakamalakib/Projects/akib/php_projects/fleepness-app/public/storage' => 'string',
            ...
            'services.livekit.egress.s3.key' => 'string',
            'services.livekit.egress.s3.secret' => 'string',
            'services.livekit.egress.s3.region' => 'string',
            'services.livekit.egress.s3.bucket' => 'string',
            'services.livekit.egress.s3.url' => 'NULL',
            'services.livekit.egress.s3.endpoint' => 'NULL',
            'services.livekit.egress.s3.use_path_style_endpoint' => 'boolean',
            'services.livekit.egress.r2.key' => 'string',
            'services.livekit.egress.r2.secret' => 'string',
            'services.livekit.egress.r2.region' => 'NULL',
            'services.livekit.egress.r2.bucket' => 'string',
            'services.livekit.egress.r2.url' => 'string',
            'services.livekit.egress.r2.endpoint' => 'string',
            'services.livekit.egress.r2.use_path_style_endpoint' => 'boolean',
            'services.livekit.egress.file_path' => 'string',
            'services.livekit.egress.thumbnail_capture_inteval' => 'integer',
            'services.livekit.egress.short_video_duration' => 'integer',
            ...
            'services.smsq.api_key' => 'string',
            'services.smsq.client_id' => 'string',
            'services.smsq.sender_id' => 'string',
            'services.smsq.api_url' => 'string',
            ...
            'webhook-client.configs.0.store_headers' => 'string',
...
'create-livestream','get-livestream-publisher-token','get-livestream-subscriber-token',);
...
'broadcasting.connections.fcm.driver','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.r2.driver',
'filesystems.disks.r2.key','filesystems.disks.r2.secret','filesystems.disks.r2.region','filesystems.disks.r2.bucket','filesystems.disks.r2.url',
'filesystems.disks.r2.endpoint','filesystems.disks.r2.use_path_style_endpoint','filesystems.disks.r2.throw','filesystems.links./Users/mdmohiuddinmostafakamalakib/Projects/akib/php_projects/fleepness-app/public/storage','firebase.default',
...
'firebase.projects.app.http_client_options.timeout','firebase.projects.app.http_client_options.guzzle_middlewares','firebase.credentials','logging.default','logging.deprecations.channel',
...
'media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','model-status.status_model','model-status.status_attribute',
'model-status.model_primary_key_attribute','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting','octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
...
'services.google.redirect','services.livekit.host','services.livekit.api_key','services.livekit.api_secret','services.livekit.egress.s3.key',
'services.livekit.egress.s3.secret','services.livekit.egress.s3.region','services.livekit.egress.s3.bucket','services.livekit.egress.s3.url','services.livekit.egress.s3.endpoint',
'services.livekit.egress.s3.use_path_style_endpoint','services.livekit.egress.r2.key','services.livekit.egress.r2.secret','services.livekit.egress.r2.region','services.livekit.egress.r2.bucket',
'services.livekit.egress.r2.url','services.livekit.egress.r2.endpoint','services.livekit.egress.r2.use_path_style_endpoint','services.livekit.egress.file_path','services.livekit.egress.thumbnail_capture_inteval',
'services.livekit.egress.short_video_duration','services.facebook.client_id','services.facebook.client_secret','services.facebook.redirect','services.apple.client_id',
...
'services.smsq.api_key','services.smsq.client_id','services.smsq.sender_id','services.smsq.api_url','session.driver',
...
'sms.driver','webhook-client.configs.0.name','webhook-client.configs.0.signing_secret','webhook-client.configs.0.signature_header_name','webhook-client.configs.0.signature_validator',
...
'webhook-client.delete_after_days','webhook-client.add_unique_token_to_route_name','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'sanctum.csrf-cookie','auth.store-device-token',
'get.categories','get.categories.by.order','get.random.tags','get.tag.info',
'get.product.by.tag','get.own.product.by.tag','size-template.update-size','get.tags','livestreams.store','livestreams.update',
'livestreams.index','livestreams.show','livestreams.get-publisher-token','livestream-products.store','livestream-products.destroy','livestreams.likes-count',
'livestreams.get-subscriber-token','webhook-client-livekit','dashboard','profile.edit','profile.update','profile.destroy','vendor.dashboard','vendor.products.index','vendor.products.create','vendor.products.store',
'vendor.products.show','vendor.products.edit','vendor.products.update','vendor.products.destroy','vendor.product-image-delete',
'vendor.product-stock-delete','vendor.get.tags','vendor.videos','vendor.video.store','vendor.video.update',
'vendor.video.delete','vendor.profile.edit','vendor.profile.update','vendor.order.index','vendor.order.pending',
'vendor.order.details','vendor.order.confirmed','vendor.order.processing','vendor.order.ready','vendor.order.shipped',
'vendor.order.delivered','vendor.order.completed','vendor.order.cancled','vendor.order.pending-confirm','vendor.order.confirm-processing',
'vendor.order.processing-ready-ship','vendor.order.pending-cancel','vendor.order.processing-delivered','vendor.order.invoice.download','vendor.payment.request',
'vendor.money.withdraw','vendor.payment.history','create.vendor.account','vendor.application','create.rider.account',
'rider.application','admin.sections.index','admin.sections.create',
'admin.sections.store','admin.sections.show','admin.sections.edit','admin.sections.update','admin.sections.destroy',
'admin.sections.reorder','admin.dashboard','admin.categories.index','admin.categories.create','admin.categories.store',
'admin.categories.show','admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.products.index',
'admin.products.create','admin.products.store','admin.products.show','admin.products.edit','admin.products.update',
'admin.products.destroy','admin.fees.index','admin.fees.storeOrUpdate','admin.order.all','admin.order.completed',
'admin.order.view','admin.order.updateSellerOrder','admin.sliders.index','admin.sliders.create','admin.sliders.store',
'admin.sliders.show','admin.sliders.edit','admin.sliders.update','admin.sliders.destroy','admin.getTags',
'admin.user.list','admin.user.store','admin.user.edit','admin.user.update','admin.user.destroy',
'admin.settings.index','admin.settings.update','admin.payment.requests','admin.payment.history','admin.payment.update',
'admin.payment-methods.index','admin.payment-methods.create','admin.payment-methods.store','admin.payment-methods.edit','admin.payment-methods.update',
'admin.payment-methods.destroy','admin.shop-categories.index','admin.shop-categories.show','admin.shop-categories.store','admin.shop-categories.update',
'admin.shop-categories.destroy','admin.delivery.models.index','admin.delivery.models.create','admin.delivery.models.store','admin.delivery.models.edit',
'admin.delivery.models.update','admin.delivery.models.destroy','registerdsfgsdf','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.admin_dashboard','admin.body.footer','admin.body.header','admin.body.sidebar','admin.categories.category_edit',
'admin.categories.index','admin.delivery_models.create','admin.delivery_models.edit','admin.delivery_models.index','admin.fees.form',
'admin.index','admin.order.cancle','admin.order.completed','admin.order.confirm','admin.order.delivered',
'admin.order.details','admin.order.index','admin.order.invoice','admin.order.pending','admin.order.processing',
'admin.order.ready','admin.order.shipped','admin.order.show','admin.payment.history','admin.payment.requests',
'admin.payment_methods.create','admin.payment_methods.edit','admin.payment_methods.index','admin.products.index','admin.products.product_edit',
'admin.profile.edit','admin.sections.create','admin.sections.edit','admin.sections.index','admin.settings',
'admin.shop_category.index','admin.sliders.edit_slider_modal','admin.sliders.index','admin.user.index','admin_dashboard',
...
'components.dropdown-link','components.guest-layout','components.input-error','components.input-label','components.modal',
...
'customer.vendor-review','dashboard','layouts.app','layouts.guest','layouts.navigation',
'media-library::image','media-library::placeholderSvg','media-library::responsiveImage','media-library::responsiveImageWithPlaceholder','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','rider.account.create','vendor.account.create',
'vendor.body.footer','vendor.body.header','vendor.body.sidebar','vendor.index','vendor.media-library.image',
'vendor.media-library.placeholderSvg','vendor.media-library.responsiveImage','vendor.media-library.responsiveImageWithPlaceholder','vendor.media.short-videos','vendor.order.cancle',
'vendor.order.completed','vendor.order.confirm','vendor.order.delivered','vendor.order.details','vendor.order.index',
'vendor.order.invoice','vendor.order.pending','vendor.order.processing','vendor.order.ready','vendor.order.shipped',
'vendor.payment.history','vendor.payment.request','vendor.products.index','vendor.products.product_edit','vendor.profile.edit',
'vendor.vendor_dashboard','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
...
'SESSION_DOMAIN','BROADCAST_CONNECTION','BROADCAST_DRIVER','FILESYSTEM_DISK','QUEUE_CONNECTION',
...
'OCTANE_SERVER','SMS_API_KEY','SMS_CLIENT_ID','SMS_SENDER_ID','SMS_API_URL',
'LIVEKIT_URL','LIVEKIT_API_KEY','LIVEKIT_API_SECRET','CLOUDFLARE_R2_ACCESS_KEY_ID','CLOUDFLARE_R2_SECRET_ACCESS_KEY',
'CLOUDFLARE_R2_BUCKET','CLOUDFLARE_R2_ENDPOINT','CLOUDFLARE_R2_URL','SMS_DRIVER',);
