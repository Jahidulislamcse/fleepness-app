...
'sanctum.csrf-cookie','auth.store-device-token','get.categories','get.categories.by.order','get.random.tags',
'get.tag.info','get.product.by.tag','get.own.product.by.tag',
'size-template.update-size','get.tags',
'livestreams.index','livestreams.show','livestreams.store','livestreams.update','livestreams.get-publisher-token',
'livestream-products.store','livestream-products.destroy','livestreams.likes-count','livestreams.get-subscriber-token','webhook-client-livekit',
'dashboard','profile.edit','profile.update','profile.destroy',
'vendor.dashboard','vendor.products.index','vendor.products.create','vendor.products.store','vendor.products.show',
'vendor.products.edit','vendor.products.update','vendor.products.destroy','vendor.product-image-delete','vendor.product-stock-delete',
'vendor.get.tags','vendor.videos','vendor.video.store','vendor.video.update','vendor.video.delete',
'vendor.profile.edit','vendor.profile.update','vendor.order.index','vendor.order.pending','vendor.order.details',
'vendor.order.confirmed','vendor.order.processing','vendor.order.ready','vendor.order.shipped','vendor.order.delivered',
'vendor.order.completed','vendor.order.cancled','vendor.order.pending-confirm','vendor.order.confirm-processing','vendor.order.processing-ready-ship',
'vendor.order.pending-cancel','vendor.order.processing-delivered','vendor.order.invoice.download','vendor.payment.request','vendor.money.withdraw',
'vendor.payment.history','create.vendor.account','vendor.application','create.rider.account','rider.application','admin.sections.index','admin.sections.create','admin.sections.store',
'admin.sections.show','admin.sections.edit','admin.sections.update','admin.sections.destroy','admin.sections.reorder',
'admin.dashboard','admin.categories.index','admin.categories.create','admin.categories.store','admin.categories.show',
...
'admin.fees.index','admin.fees.storeOrUpdate','admin.order.all','admin.order.view','admin.order.updateSellerOrder',
'admin.sliders.index','admin.sliders.create','admin.sliders.store','admin.sliders.show','admin.sliders.edit',
'admin.sliders.update','admin.sliders.destroy','admin.getTags','admin.user.list','admin.user.store',
'admin.user.edit','admin.user.update','admin.user.destroy','admin.settings.index','admin.settings.update',
'admin.payment.requests','admin.payment.history','admin.payment.update','admin.payment-methods.index','admin.payment-methods.create',
'admin.payment-methods.store','admin.payment-methods.edit','admin.payment-methods.update','admin.payment-methods.destroy','admin.shop-categories.index',
'admin.shop-categories.show','admin.shop-categories.store','admin.shop-categories.update','admin.shop-categories.destroy','admin.delivery.models.index',
'admin.delivery.models.create','admin.delivery.models.store','admin.delivery.models.edit','admin.delivery.models.update','admin.delivery.models.destroy',
'payment.requests','register','login',
