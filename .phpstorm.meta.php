...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.livekit.egress.r2.key' => 'NULL',
            'services.livekit.egress.r2.secret' => 'NULL',
            'services.livekit.egress.r2.region' => 'NULL',
            'services.livekit.egress.r2.bucket' => 'NULL',
            'services.livekit.egress.r2.url' => 'NULL',
            'services.livekit.egress.r2.endpoint' => 'NULL',
            ...
            'services.smsq.api_key' => 'NULL',
            'services.smsq.client_id' => 'NULL',
            'services.smsq.sender_id' => 'NULL',
            'services.smsq.api_url' => 'NULL',
...
'broadcasting.connections.fcm.driver','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.session.driver',
...
'filesystems.links./Users/akib/Projects/akib/php_projects/fleepness-app/public/storage','firebase.default','firebase.projects.app.credentials','firebase.projects.app.auth.tenant_id','firebase.projects.app.firestore',
...
'model-status.status_model','model-status.status_attribute','model-status.model_primary_key_attribute','octane.server','octane.https',
...
'services.google.client_id','services.google.client_secret','services.google.redirect','services.livekit.host','services.livekit.api_key',
'services.livekit.api_secret','services.livekit.egress.s3.key','services.livekit.egress.s3.secret','services.livekit.egress.s3.region','services.livekit.egress.s3.bucket',
'services.livekit.egress.s3.url','services.livekit.egress.s3.endpoint','services.livekit.egress.s3.use_path_style_endpoint','services.livekit.egress.r2.key','services.livekit.egress.r2.secret',
'services.livekit.egress.r2.region','services.livekit.egress.r2.bucket','services.livekit.egress.r2.url','services.livekit.egress.r2.endpoint','services.livekit.egress.r2.use_path_style_endpoint',
'services.livekit.egress.file_path','services.livekit.egress.thumbnail_capture_inteval','services.livekit.egress.short_video_duration','services.facebook.client_id','services.facebook.client_secret',
'services.facebook.redirect','services.apple.client_id','services.apple.client_secret','services.apple.redirect','services.apple.team_id',
'services.apple.key_id','services.apple.key_file','services.smsq.api_key','services.smsq.client_id','services.smsq.sender_id',
'services.smsq.api_url','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','webhook-client.configs.0.name','webhook-client.configs.0.signing_secret','webhook-client.configs.0.signature_header_name',
...
'webhook-client.configs.0.process_webhook_job','webhook-client.delete_after_days','webhook-client.add_unique_token_to_route_name','data.date_format','data.date_timezone',
...
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','SESSION_DRIVER',
