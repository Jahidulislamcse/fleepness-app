...
'get-livestream-publisher-token','get-livestream-subscriber-token',);
...
'filesystems.disks.r2.driver','filesystems.disks.r2.key','filesystems.disks.r2.secret','filesystems.disks.r2.region','filesystems.disks.r2.bucket',
'filesystems.disks.r2.url','filesystems.disks.r2.endpoint','filesystems.disks.r2.use_path_style_endpoint','filesystems.disks.r2.throw','filesystems.links./Users/mdmohiuddinmostafakamalakib/Projects/akib/php_projects/fleepness-app/public/storage',
...
'firebase.projects.app.http_client_options.proxy','firebase.projects.app.http_client_options.timeout','firebase.projects.app.http_client_options.guzzle_middlewares','firebase.credentials','logging.default',
...
'media-library.prefix','media-library.force_lazy_loading','model-status.status_model','model-status.status_attribute','model-status.model_primary_key_attribute',
...
'services.apple.key_id','services.apple.key_file','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','sms.api_key','sms.client_id',
'sms.sender_id','sms.api_url','webhook-client.configs.0.name','webhook-client.configs.0.signing_secret','webhook-client.configs.0.signature_header_name',
...
'sanctum.csrf-cookie','auth.store-device-token','get.categories','get.categories.by.order',
'get.random.tags','get.tag.info','get.product.by.tag','get.own.product.by.tag','size-template.update-size',
'get.tags','livestreams.index','livestreams.show','livestreams.store','livestreams.update',
'livestreams.get-publisher-token','livestream-products.store','livestream-products.destroy','livestreams.likes-count','livestreams.get-subscriber-token',
'webhook-client-livekit','dashboard','profile.edit','profile.update','profile.destroy','vendor.dashboard','vendor.products.index','vendor.products.create','vendor.products.store',
...
'admin.products.destroy','admin.fees.index','admin.fees.storeOrUpdate','admin.order.all','admin.order.view',
'admin.order.updateSellerOrder','admin.sliders.index','admin.sliders.create','admin.sliders.store','admin.sliders.show',
'admin.sliders.edit','admin.sliders.update','admin.sliders.destroy','admin.getTags','admin.user.list',
'admin.user.store','admin.user.edit','admin.user.update','admin.user.destroy','admin.settings.index',
'admin.settings.update','admin.payment.requests','admin.payment.history','admin.payment.update','admin.payment-methods.index',
'admin.payment-methods.create','admin.payment-methods.store','admin.payment-methods.edit','admin.payment-methods.update','admin.payment-methods.destroy',
'admin.shop-categories.index','admin.shop-categories.show','admin.shop-categories.store','admin.shop-categories.update','admin.shop-categories.destroy',
'admin.delivery.models.index','admin.delivery.models.create','admin.delivery.models.store','admin.delivery.models.edit','admin.delivery.models.update',
'admin.delivery.models.destroy','payment.requests','register','login','password.request','password.email','password.reset','password.store',
