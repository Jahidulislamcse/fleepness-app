                    ...
                    <table class="table" style="background:#F4F6FA;font-weight: 600;">
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="{{ route('admin.order.ready-shipped', $orderInfo->id) }}"
                                    class="btn btn-block btn-success" id="ship">Mark as shipped</a>
                                @elseif($orderInfo->status == 'shipped')
                                <a href="{{ route('admin.order.shipped-delivered', $orderInfo->id) }}"
                                    class="btn btn-block btn-success" id="ship">Mark as Delivered</a>
                                @elseif($orderInfo->status == 'deliverd' && $orderInfo->payment_status == 'pending')
                                <a href="{{ route('admin.order.delivered-completed', $orderInfo->id) }}"
                                    class="btn btn-block btn-success" id="completed"
                                    onclick="return confirm('Are you sure to mark this order Completed ?');">Mark as Completed</a>
