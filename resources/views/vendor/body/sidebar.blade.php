            ...
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item ">
                    ...
                    <div class="collapse " id="order">
                        <ul class="nav nav-collapse">
                            ...
                            <li class=""> <a href="{{ route('vendor.order.ready') }}">Ready Orders</a></li>
                            <li class=""> <a href="{{ route('vendor.order.shipped') }}">Shipped Orders</a></li>
                ...
                <li class="nav-item ">
                    ...
                    <div class="collapse " id="base2">
                        <ul class="nav nav-collapse">
                            <li class="">
                                <a href="{{ route('vendor.videos') }}">
                                    <span class="sub-item">Short Videos</span>
                                </a>
                            </li>
                        </ul>
                    </div>
